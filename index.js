...
const proyectos = [
  {
    ...
    tecnologias: [
      { nombre: "HTML", logo: "src/html5-brands-solid.svg" },
      { nombre: "CSS", logo: "src/css-brands.svg" },
      { nombre: "JavaScript", logo: "src/js-brands.svg" },
      { nombre: "Firebase", logo: "src/firebase.svg" }
    ],
  ...
  },
  {
    ...
    tecnologias: [
      ...
      { nombre: "CSS", logo: "src/css-brands.svg" },
      { nombre: "JavaScript", logo: "src/js-brands.svg" },
      { nombre: "Cloudinary", logo: "src/cloudinary-svgrepo-com.svg" }
    ],
